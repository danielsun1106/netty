...
public final class OpenSslCertificateException extends CertificateException {
    ...
    static {
        // Check if we could load OpenSSL and correctly assign the static fields if so. If we could not load it
        // we will fill the fields with -1 and fail once the user tries to instance an OpenSslCertificateException.
        if (OpenSsl.isAvailable()) {
            ...
            X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT = -1;
            X509_V_ERR_UNABLE_TO_GET_CRL = -1;
            X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE = -1;
            X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE = -1;
            X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY = -1;
            X509_V_ERR_CERT_SIGNATURE_FAILURE = -1;
            X509_V_ERR_CRL_SIGNATURE_FAILURE = -1;
            X509_V_ERR_CERT_NOT_YET_VALID = -1;
            X509_V_ERR_CERT_HAS_EXPIRED = -1;
            X509_V_ERR_CRL_NOT_YET_VALID = -1;
            X509_V_ERR_CRL_HAS_EXPIRED = -1;
            X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD = -1;
            X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD = -1;
            X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD = -1;
            X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD = -1;
            X509_V_ERR_OUT_OF_MEM = -1;
            X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT = -1;
            X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN = -1;
            X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY = -1;
            X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE = -1;
            X509_V_ERR_CERT_CHAIN_TOO_LONG = -1;
            X509_V_ERR_CERT_REVOKED = -1;
            X509_V_ERR_INVALID_CA = -1;
            X509_V_ERR_PATH_LENGTH_EXCEEDED = -1;
            X509_V_ERR_INVALID_PURPOSE = -1;
            X509_V_ERR_CERT_UNTRUSTED = -1;
            X509_V_ERR_CERT_REJECTED = -1;
            X509_V_ERR_SUBJECT_ISSUER_MISMATCH = -1;
            X509_V_ERR_AKID_SKID_MISMATCH = -1;
            X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH = -1;
            X509_V_ERR_KEYUSAGE_NO_CERTSIGN = -1;
            X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER = -1;
            X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION = -1;
            X509_V_ERR_KEYUSAGE_NO_CRL_SIGN = -1;
            X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION = -1;
            X509_V_ERR_INVALID_NON_CA = -1;
            X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED = -1;
            X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE = -1;
            X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED = -1;
            X509_V_ERR_INVALID_EXTENSION = -1;
            X509_V_ERR_INVALID_POLICY_EXTENSION = -1;
            X509_V_ERR_NO_EXPLICIT_POLICY = -1;
            X509_V_ERR_DIFFERENT_CRL_SCOPE = -1;
            X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE = -1;
            X509_V_ERR_UNNESTED_RESOURCE = -1;
            X509_V_ERR_PERMITTED_VIOLATION = -1;
            X509_V_ERR_EXCLUDED_VIOLATION = -1;
            X509_V_ERR_SUBTREE_MINMAX = -1;
            X509_V_ERR_APPLICATION_VERIFICATION = -1;
            X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE = -1;
            X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX = -1;
            X509_V_ERR_UNSUPPORTED_NAME_SYNTAX = -1;
            X509_V_ERR_CRL_PATH_VALIDATION_ERROR = -1;
            X509_V_ERR_PATH_LOOP = -1;
            X509_V_ERR_SUITE_B_INVALID_VERSION = -1;
            X509_V_ERR_SUITE_B_INVALID_ALGORITHM = -1;
            X509_V_ERR_SUITE_B_INVALID_CURVE = -1;
            X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM = -1;
            X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED = -1;
            X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256 = -1;
            X509_V_ERR_HOSTNAME_MISMATCH = -1;
            X509_V_ERR_EMAIL_MISMATCH = -1;
            X509_V_ERR_IP_ADDRESS_MISMATCH = -1;
            X509_V_ERR_DANE_NO_MATCH = -1;
    ...
    private static int checkErrorCode(int errorCode) {
        if (ERROR_MAP == null) {
            // We could not load OpenSSL before, so fail here.
